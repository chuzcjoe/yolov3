...
wdir = 'results' + os.sep + 'yolov3' + os.sep # weights dir
last = wdir + 'aug_last.pt'
best = wdir + 'aug_best.pt'
...
def train():
    ...
    finetune_path = data_dict['finetune']
    ...
    # check if it is fien-tune
    if opt.finetune:
        print(opt.finetune)
        train_path = finetune_path
        print("fine tuning...")
    # Dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_size', nargs='+', type=int, default=[320, 640], help='[min_train, max-train, test] img sizes')
    parser.add_argument('--rect', action='store_true', help='rectangular training')
    parser.add_argument('--resume', action='store_true', help='resume training from last.pt')
    parser.add_argument('--finetune', type=int, default=0, help='If use fine-tune')
